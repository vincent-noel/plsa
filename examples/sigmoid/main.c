...
int 	main (int argc, char ** argv)
{
	...
	params->array[0] = (ParamList) { &k, 1e-6, (Range) {0,1e+16}, "k"};
	params->array[1] = (ParamList) { &n, 1e-6, (Range) {0,1e+16}, "n"};
	params->array[2] = (ParamList) { &theta, 1e-6, (Range) {0,1e+16}, "theta"};
	params->array[3] = (ParamList) { &basal, 1e-6, (Range) {0,1e+16}, "basal"};
